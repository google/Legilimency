...
#The offset of the base address field in the AppleBCMWLANPCIeCompletionRing instance
BASE_ADDRESS_OFFSET = 216

#The offset of the element size field in the AppleBCMWLANPCIeCompletionRing instance
ELEMENT_SIZE_OFFSET = 92

#The offset of the index pointer field in the AppleBCMWLANPCIeCompletionRing instance
INDEX_POINTER_OFFSET = 144

class AppleBCMWLANPCIeCompletionRing(object):
    """
    This class is used to represent an AppleBCMWLANPCIeCompletionRing instance
    """
